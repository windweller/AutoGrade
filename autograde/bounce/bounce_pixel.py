...
# speed change
# theme change (no longer matters)
# Let's collapse both and see where it gets us...only ONE correct environment, not multiple (to make it easy to understand)
# And if we need, future work, we can do it
# Goal: tonight, you can train a DQN on Bounce and see how long it takes... (have more CPU samples) (shrink environment)
